...
export FUSIONAUTH_1025=`gp url 1025`
...
perl -pi -e 's#mailcatcher#$ENV{FUSIONAUTH_1025}#g' kickstart/kickstart.json
perl -pi -e 's#"port": 1025#"port":443#g' kickstart/kickstart.json
